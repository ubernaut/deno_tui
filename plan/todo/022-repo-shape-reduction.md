...
- Tracked files after the current consolidation passes: `721`
...
- Handwritten/code-heavy line counts:
  ...
  - `tests`: `49,094` lines across `154` files
...
- Completed first passes:
  ...
  - tiny theme catalog, ANSI facade, layer stack, manifest, and validation tests are now `tests/theme_core.test.ts`
