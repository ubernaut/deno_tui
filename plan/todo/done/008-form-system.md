...
- Added schema-backed form construction, whole-form validation, grouped inspection metadata, error summaries, disabled and
  read-only field state, and submit results.
