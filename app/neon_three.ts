...
function addAsciiWireOverlays(root: THREE.Object3D, thickness = 2): void {
...
export function createNeonThreeScene(mode: ThreeSceneMode, options: NeonThreeSceneOptions = {}): NeonThreeSceneBundle {
