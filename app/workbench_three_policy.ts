...
export const WORKBENCH_THREE_INITIAL_CELLS = WORKBENCH_THREE_RESCUE_CELLS;
...
export const WORKBENCH_THREE_PRESSURE_HIGH_BYTES_PER_SECOND = 35_000;
export const WORKBENCH_THREE_PRESSURE_LOW_BYTES_PER_SECOND = 12_000;
