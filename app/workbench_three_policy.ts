...
export const WORKBENCH_THREE_INITIAL_CELLS = 240;
...
export const WORKBENCH_THREE_PRESSURE_LOW_BYTES_PER_GRID = 1_500;
export const WORKBENCH_THREE_PRESSURE_HIGH_BYTES_PER_SECOND = 70_000;
...
export const WORKBENCH_THREE_PRESSURE_LOW_FRAME_THRESHOLD = 60;
...
export const WORKBENCH_THREE_FRAME_INTERVAL_BY_CELLS = new Map<number, number>([
  [WORKBENCH_THREE_EMERGENCY_CELLS, WORKBENCH_THREE_DRAW_INTERVAL_MS],
