...
| Audio visualizer     | The butterchurn field is a MilkDrop-style feedback visualizer driven by the microphone        |
...
It is a real package rather than an example: `packages/exomux` carries its own `deno.json`, its own `deno.lock`, and 241
