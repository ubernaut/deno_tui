...
Deno.test("benchmark CLI catalog covers high-volume TUI workloads", () => {
  ...
  assertEquals(report.inspection.count, 87);
  assertEquals(report.inspection.thresholded, 87);
  ...
  assertEquals(names.includes("render/three-panel-grid-scale-into-220x70"), true);
  assertEquals(names.includes("render/three-panel-grid-scale-cached-220x70"), true);
  ...
  assertEquals(names.includes("render/workbench-prefilled-cell-blit-viewport"), true);
  ...
  assertEquals(names.includes("render/workbench-ansi-screen-span-flush-168x54"), true);
  ...
  assertEquals(names.includes("render/workbench-three-fullscreen-pressure-policy"), true);
  assertEquals(names.includes("render/three-panel-grid-scale-220x70"), true);
  assertEquals(names.includes("render/three-panel-grid-revision-publication"), true);
  ...
  assertEquals(names.includes("render/three-ascii-initial-frame-diff-96x40"), true);
  ...
  assertEquals(names.includes("render/three-ascii-render-profile-1k"), true);
