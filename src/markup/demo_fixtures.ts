...
/** Stable option id used by launchers for the HTML/CSS layout demo fixture. */
...
/** Options for creating the reusable HTML/CSS layout demo fixture. */
...
/** Returns a compact display label for one box in the HTML/CSS layout demo. */
