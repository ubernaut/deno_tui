...
export const WORKBENCH_THREE_FULLSCREEN_PRESSURE_HIGH_BYTES_PER_SECOND = 140_000;
export const WORKBENCH_THREE_FULLSCREEN_PRESSURE_LOW_BYTES_PER_SECOND = 60_000;
